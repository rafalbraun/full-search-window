...
#define DEBUG_DOCUMENT 0
#define XED_SETTINGS_SEARCH_HIGHLIGHTING 1
#define XED_SETTINGS_BRACKET_MATCHING 2
#define XED_SETTINGS_MAX_UNDO_ACTIONS 3 
#define XED_SETTINGS_SYNTAX_HIGHLIGHTING 4
#define XED_SETTINGS_SCHEME 5
#define XED_SETTINGS_ENSURE_TRAILING_NEWLINE 6
